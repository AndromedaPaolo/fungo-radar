      ...
      <header className="z-20 border-b border-border/80 bg-[color-mix(in_oklch,var(--background)_88%,var(--primary)_12%)] px-4 py-3 md:px-6">
        ...
        <div className="mt-4 flex flex-col gap-3">
          <div className="flex flex-wrap items-center gap-2">
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="tutte">Stazioni tutte</SelectItem>
                <SelectItem value="grandi">Solo grandi</SelectItem>
                <SelectItem value="piccole">Solo piccole</SelectItem>
        ...
        <div className="mt-3 flex flex-col gap-3 md:flex-row md:items-center">
          ...
          <p className="text-sm text-muted-foreground">
            {zones.length} boschi
            {snapshot
              ? ` · ${snapshot.summary.sitesScanned} letti · ${snapshot.stations?.length ?? 0} stazioni`
              : null}
          </p>
        </div>
      </header>
    ...
    <div className="min-h-64 flex-1 overflow-y-auto">
      <div className="space-y-4 p-4">
        ...
        <p className="text-[11px] leading-relaxed text-muted-foreground">
          ...
          nodi piccoli di crinale. Il cerchio è un bosco di una frazione, sul versante indicato.
