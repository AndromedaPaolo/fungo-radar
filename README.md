...
Il sito è sempre online su Vercel. L’indirizzo di produzione è indicato qui dopo il primo deploy.

Il bollettino del giorno è incluso nel deploy (`data/latest.json.gz` / `data/latest.b64`), così la mappa non deve ricalcolare il meteo a ogni visita.
